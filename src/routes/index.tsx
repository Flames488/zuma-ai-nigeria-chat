...
const demoConversation: ChatMsg[] = [
  ...
  { from: "bot", text: "Good morning dear! 🌞 Yes o, we sell quality Ankara gowns, senator wear and Aso-ebi. What style catch your eye?", time: "9:02" },
  { from: "customer", text: "How much for the blue Ankara gown?", time: "9:03" },
  { from: "bot", text: "The blue Ankara gown is ₦15,000 💙 — premium fabric, fits sizes 8 to 18. Want me to reserve one for you?", time: "9:03" },
  { from: "customer", text: "Yes please. Size 12. Deliver to Lekki Phase 1.", time: "9:04" },
  { from: "bot", text: "Got it ✨ Size 12, delivery to Lekki Phase 1 (₦2,500). Total = ₦17,500. Fit I get your name & phone abeg?", time: "9:04" },
  { from: "customer", text: "Adaeze Okoro, 0803 555 1212", time: "9:05" },
  { from: "bot", text: "Thanks Adaeze 🙌 Here's your secure payment link:\nhttps://paystack.com/pay/wabizz-x84n\n\nOnce you pay, reply PAID and we'll dispatch today!", time: "9:05" },
  { from: "customer", text: "PAID ✅", time: "9:08" },
  { from: "bot", text: "Confirmed! 🎉 Your order is being packed. Dispatch rider arrives between 2 – 4pm today. Thank you for shopping with us 💚", time: "9:08" },
];
